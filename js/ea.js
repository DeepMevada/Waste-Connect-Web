...
db.ref("patient").on("value", function (getdata) {
...
function alertdoc() {
  ...
  alert(
    " Send Message To " + doclist[Math.floor(Math.random() * doclist.length)]
  );
}
...
function startot() {
  ...
  alert(
    " Prepare Operation Theatre No. " +
      otlist[Math.floor(Math.random() * otlist.length)]
  );
}
